...
# Create Frameworks
xcodebuild -workspace idenfySdk.xcworkspace -scheme idenfyviews -configuration Release -derivedDataPath $PROJECT_DIR/../devices -sdk iphoneos ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme idenfyviews -configuration Release -derivedDataPath $PROJECT_DIR/../simulators -sdk iphonesimulator ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme idenfycore -configuration Release -derivedDataPath $PROJECT_DIR/../devices -sdk iphoneos ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme idenfycore -configuration Release -derivedDataPath $PROJECT_DIR/../simulators -sdk iphonesimulator ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme idenfyNFCReading -configuration Release -derivedDataPath $PROJECT_DIR/../devices -sdk iphoneos ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme idenfyNFCReading -configuration Release -derivedDataPath $PROJECT_DIR/../simulators -sdk iphonesimulator ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme IdenfyLiveness -configuration Release -derivedDataPath $PROJECT_DIR/../devices -sdk iphoneos ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme IdenfyLiveness -configuration Release -derivedDataPath $PROJECT_DIR/../simulators -sdk iphonesimulator ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme IdenfySDK -configuration Release -derivedDataPath $PROJECT_DIR/../devices -sdk iphoneos ONLY_ACTIVE_ARCH=NO ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme IdenfySDK -configuration Release -derivedDataPath $PROJECT_DIR/../simulators -sdk iphonesimulator ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode ONLY_ACTIVE_ARCH=NO SWIFT_ACTIVE_COMPILATION_CONDITIONS="" OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme IdenfySDK -configuration Release -derivedDataPath $PROJECT_DIR/../devices/liveness -sdk iphoneos ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode ONLY_ACTIVE_ARCH=NO SWIFT_ACTIVE_COMPILATION_CONDITIONS=IDENFY_LIVELINESS OTHER_CFLAGS="-fembed-bitcode" clean archive

xcodebuild -workspace idenfySdk.xcworkspace -scheme IdenfySDK -configuration Release -derivedDataPath $PROJECT_DIR/../simulators/liveness -sdk iphonesimulator ENABLE_BITCODE=YES BITCODE_GENERATION_MODE=bitcode ONLY_ACTIVE_ARCH=NO SWIFT_ACTIVE_COMPILATION_CONDITIONS=IDENFY_LIVELINESS OTHER_CFLAGS="-fembed-bitcode" clean archive
...
mkdir $PROJECT_DIR/../output/IdenfyAssets/V1
mkdir $PROJECT_DIR/../output/IdenfyAssets/V2
cp -R $PROJECT_DIR/iDenfySDK/idenfyassets/IdenfyImagesV1.xcassets $PROJECT_DIR/../output/IdenfyAssets/V1
cp -R $PROJECT_DIR/idenfyviews/assets $PROJECT_DIR/../output/IdenfyAssets/V2
cp -R $PROJECT_DIR/iDenfySDK/idenfyviewslegacy/designv1/storyboards/Idenfy.storyboard $PROJECT_DIR/../output/IdenfyAssets/V1
