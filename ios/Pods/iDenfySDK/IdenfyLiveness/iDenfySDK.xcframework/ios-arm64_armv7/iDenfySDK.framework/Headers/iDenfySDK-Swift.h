...
@property (nonatomic) IBInspectable CGFloat lineWidthIpad;
...
SWIFT_CLASS("_TtC9iDenfySDK13IdenfyBuilder") SWIFT_DEPRECATED_MSG("Use the V2 version")
...
+ (void)continueFlow;
- (void)handleIDenfyCallbacksOnSuccess:(void (^ _Nonnull)(AuthenticationResultResponse * _Nonnull))onSuccess onError:(void (^ _Nonnull)(IdenfyErrorResponse * _Nonnull))onError onUserExit:(void (^ _Nonnull)(void))onUserExit SWIFT_DEPRECATED_MSG("Use the V2 version");
...
///
/// \param idenfyOnSdkClose A callback for receiving when the SDK closes.
///
...
- (void)initializeIdenfySDKWithIdenfySettings:(IdenfySettings * _Nonnull)idenfySettings SWIFT_DEPRECATED_MSG("Use the V2 version");
...
SWIFT_CLASS("_TtC9iDenfySDK35IdenfyIdentificationResultsSettings") SWIFT_DEPRECATED_MSG("Use the V2 version")
...
typedef SWIFT_ENUM(NSInteger, IdenfyLocaleEnum, open) {
  ...
  IdenfyLocaleEnumET = 12,
  IdenfyLocaleEnumCS = 13,
};
...
SWIFT_CLASS("_TtC9iDenfySDK26IdenfyNavigationUISettings") SWIFT_DEPRECATED_MSG("Use the V2 version")
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull inspectableIdenfyTransparentCameraOverlayColor;
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull inspectableIdenfyPhotoResultBackgroundColor;
@property (nonatomic) IBInspectable CGFloat inspectableIdenfyOverlayStrokeRadius;
@property (nonatomic) IBInspectable CGFloat inspectableIdenfyDocumentShapeRadius;
- (void)drawRect:(CGRect)rect;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9iDenfySDK14IdenfySettings") SWIFT_DEPRECATED_MSG("Use the V2 version")
...
SWIFT_CLASS("_TtC9iDenfySDK15IdenfyUIBuilder") SWIFT_DEPRECATED_MSG("Use the V2 version")
...
SWIFT_CLASS("_TtC9iDenfySDK16IdenfyUISettings") SWIFT_DEPRECATED_MSG("Use the V2 version")
...
SWIFT_CLASS("_TtC9iDenfySDK31IdentificationSessionUISettings") SWIFT_DEPRECATED_MSG("Use the V2 version")
...
SWIFT_CLASS("_TtC9iDenfySDK18OverlayTextBuilder") SWIFT_DEPRECATED_MSG("Use the V2 version")
