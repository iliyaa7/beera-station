...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/idenfy-react-native-sdk/idenfy_react_native_sdk.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/lottie-ios/Lottie.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-safe-area-context/react_native_safe_area_context.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/stripe-react-native/stripe_react_native.framework"
